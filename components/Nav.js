        ...
        {navData.map((link, index) => {
          return (
            ...
            >
              ...
              {/* icons */}
              <div className="hover:text-accent transition-all duration-300 flex flex-col justify-center items-center text-2xl">
                {link.icon}{" "}
                <span className="text-[15px] xl:hidden capitalize">
                  {link.name}
                </span>
              </div>
            </Link>
